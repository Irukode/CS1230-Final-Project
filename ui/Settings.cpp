...
void Settings::loadSettingsOrDefaults() {
    ...
    sphereRadius = s.value("sphereRadius", 0.5f).toFloat();
    sphereMass = s.value("sphereMass", 0.5f).toFloat();
    sphereBounciness = s.value("sphereBounciness", 0.8f).toFloat();
    sphereCount = s.value("sphereCount", 0).toInt();
